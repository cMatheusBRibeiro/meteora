...
export const useCarrinhoContext = () => {
    ...
    const mudarQuantidade = (idProduto, quantidadeParaSomar) => {
        return carrinho.map((itemCarrinho) => {
            if (itemCarrinho.id === idProduto) itemCarrinho.quantidade += quantidadeParaSomar;
            return itemCarrinho;
        });
    }
    ...
    const removerProdutoCarrinho = (idProduto) => {
        const carrinhoAtualizado = carrinho.filter((itemCarrinho) => itemCarrinho.id !== idProduto);
